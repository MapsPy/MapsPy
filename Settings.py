...
PROCESS_NODE_XRF_MAPS_PATH	= 'xrf_maps_path'
PROCESS_NODE_XRF_MAPS_EXE	= 'xrf_maps_exe'
PROCESS_NODE_KEYS = [PROCESS_NODE_NAME, PROCESS_NODE_THREADS, PROCESS_NODE_DATABASE_NAME, PROCESS_NODE_XRF_MAPS_PATH, PROCESS_NODE_XRF_MAPS_EXE]
